 ...
 * on 12/28/2015.
 */
public class  ActivityOP02 extends ActivityOPRoot
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_op02);
                ...
                case 2:{
                    ...
                    if(mCorrect){
                        ...
                        ((TextView) findViewById(R.id.equalSymbol))
                                .setTextColor(ContextCompat.getColor(ActivityOP02.this,
                                        R.color.normalBlack));
                        ...
                        ((TextView) findViewById(R.id.equalSymbol))
                                .setTextColor(ContextCompat.getColor(ActivityOP02.this,
                                        R.color.normalBlack));
                        mFinalNumber.setTextColor(ContextCompat.getColor(ActivityOP02.this,
                                R.color.normalBlack));
                        mFinalNumber.setPaintFlags(mFinalNumber.getPaintFlags()
                                & (~ Paint.STRIKE_THRU_TEXT_FLAG));
                        ((ImageView) findViewById(R.id.btnValidate))
