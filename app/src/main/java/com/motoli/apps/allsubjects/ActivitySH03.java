 ...
 * on 12/28/2015.
 */
public class ActivitySH03 extends ActivitiesMasterParent
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sh03);
    ...
    private void finishBeginRound(Cursor mCursor){
        int mExtraCount=0;
        int mAllowedTypeId=0;
        if(mCursor.moveToFirst()){
            do{



                if(mAllowedTypeId==Integer.parseInt(mCursor.getString(
                        mCursor.getColumnIndex("math_shape_type_id"))) || mExtraCount==0) {
                    mExtraCount++;
                    ...
                    if(mExtraCount==1){
                        mAllowedTypeId=Integer.parseInt(mCursor.getString(
                                mCursor.getColumnIndex("math_shape_type_id")));
                    }
                }
    ...
    private void setUpFrame(int frameNumber){
        ...
        switch(frameNumber){
            default:
            case 0:{
                ((ImageView)findViewById(R.id.frame1)).setImageResource(R.drawable.frm_sh03_on);
                break;
            }
            case 1:{
                ((ImageView)findViewById(R.id.frame2)).setImageResource(R.drawable.frm_sh03_on);
                break;
            }
            case 2:{
                ((ImageView)findViewById(R.id.frame3)).setImageResource(R.drawable.frm_sh03_on);
                break;
            }
            case 3:{
                ((ImageView)findViewById(R.id.frame4)).setImageResource(R.drawable.frm_sh03_on);
                break;
            }
        }
    }
    ...
    private void clearFrames(){
        //clear frames
        ((ImageView)findViewById(R.id.frame1)).setImageResource(R.drawable.frm_sh03_off);
        ((ImageView)findViewById(R.id.frame2)).setImageResource(R.drawable.frm_sh03_off);
        ((ImageView)findViewById(R.id.frame3)).setImageResource(R.drawable.frm_sh03_off);
        ((ImageView)findViewById(R.id.frame4)).setImageResource(R.drawable.frm_sh03_off);
    ...
    private Runnable processGuess = new Runnable(){
        ...
        public void run(){
            ...
            switch(mProcessGuessPosition){
                ...
                case 1:{
                    mAudioDuration=playGeneralAudio(mCurrentShapeTypeAudio);
                    mProcessGuessPosition++;
                    mAudioHandler.postDelayed(processGuess, mAudioDuration+10);
                    break;
                }
