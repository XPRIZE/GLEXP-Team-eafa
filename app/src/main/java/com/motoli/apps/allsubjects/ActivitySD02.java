...
public class ActivitySD02 extends ActivitySDRoot 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd02);
    ...
    private void setUpFrame(int frameNumber){
        ...
        switch(frameNumber){
            default:
            case 0:{
                ((ImageView)findViewById(R.id.frame1)).setImageResource(R.drawable.frm_sd02_on);
                break;
            }
            case 1:{
                ((ImageView)findViewById(R.id.frame2)).setImageResource(R.drawable.frm_sd02_on);
                break;
            }
            case 2:{
                ((ImageView)findViewById(R.id.frame3)).setImageResource(R.drawable.frm_sd02_on);
                break;
            }
            case 3:{
                ((ImageView)findViewById(R.id.frame4)).setImageResource(R.drawable.frm_sd02_on);
                break;
            }
        }
    }
    ...
    private void clearFrames(){
        //clear frames
        ((ImageView)findViewById(R.id.frame1)).setImageResource(R.drawable.frm_sd02_off);
        ((ImageView)findViewById(R.id.frame2)).setImageResource(R.drawable.frm_sd02_off);
        ((ImageView)findViewById(R.id.frame3)).setImageResource(R.drawable.frm_sd02_off);
        ((ImageView)findViewById(R.id.frame4)).setImageResource(R.drawable.frm_sd02_off);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        switch(id){
            ...
            case Constants.CURRENT_PHONIC_LETTERS_WORDS:{
                ...
                String selection=" phonics.phonic_id=phonic_words.phonic_word_first_id  ";
            ...
            case Constants.CURRENT_PHONIC_LETTERS_WORDS_SINGLE:{
                String mWhere=" phonic_words.phonic_word_first_id" +
