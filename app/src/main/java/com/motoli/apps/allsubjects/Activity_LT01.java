...
public class Activity_LT01 extends Activity_General_Parent implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lt01);
    ...
    private long playInstructionAudio(){
        return playGeneralAudio("info_lt01.mp3");
    }
...
//		mCurrentText.add(new ArrayList<String>(allActivityText.get(roundNumber).get(0)));
    ...
    //	validateFlash.postDelayed(processValidateFlash, (long)50);
        switch(frameNumber){
            default:
            case 0:{
                ((ImageView)findViewById(R.id.Activity_TextFrame1)).setImageResource(R.drawable.frm_lt01_on);
                break;
            }
            case 1:{
                ((ImageView)findViewById(R.id.Activity_TextFrame2)).setImageResource(R.drawable.frm_lt01_on);
                break;
            }
            case 2:{
                ((ImageView)findViewById(R.id.Activity_TextFrame3)).setImageResource(R.drawable.frm_lt01_on);
                break;
            }
            case 3:{
                ((ImageView)findViewById(R.id.Activity_TextFrame4)).setImageResource(R.drawable.frm_lt01_on);
                break;
            }
        }
    }
    ...
    private void clearFrames(){
        //clear frames
        ((ImageView)findViewById(R.id.Activity_TextFrame1)).setImageResource(R.drawable.frm_lt01_off);
        ((ImageView)findViewById(R.id.Activity_TextFrame2)).setImageResource(R.drawable.frm_lt01_off);
        ((ImageView)findViewById(R.id.Activity_TextFrame3)).setImageResource(R.drawable.frm_lt01_off);
        ((ImageView)findViewById(R.id.Activity_TextFrame4)).setImageResource(R.drawable.frm_lt01_off);
    ...
    private void processData(Cursor mCursor){
        ...
        while (!mCursor.isAfterLast()) {
            ...
            mCurrentWords.get(currentWordNumber).add(mCursor.getString(mCursor.getColumnIndex("letter_id"))); //0
            mCurrentWords.get(currentWordNumber).add(mCursor.getString(mCursor.getColumnIndex("letter_text"))); //1
    ...
    private void shuffleGameData(){
        ...
        for(int currentCount=0; currentCount<mCurrentWords.size();currentCount++){
            ...
            allActivityText.get(currentCount).get(0).add(mCurrentWords.get(currentCount).get(1)); //letter_text 2
                ...
                if(!sortedWords.get(distCount).get(0).equals(letter_id) ){
                    ...
                    for(ArrayList mTemp : allActivityText.get(currentCount) ){
                        if(!sortedWords.get(distCount).get(0).equals(mTemp.get(1))){
                            ...
                            allActivityText.get(currentCount).get(distCurrentCount).add(sortedWords.get(distCount).get(1)); //letter_text
