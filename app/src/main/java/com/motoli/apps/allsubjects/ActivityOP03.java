...
public class ActivityOP03 extends ActivityOPRoot
    ...
    protected void beginRound(){
        ...
        mVerticalFinalNumber.setTextColor(getResources().getColor(R.color.normalBlack));
    ...
    protected void validate(){
        ...
        if(Integer.parseInt(mFinalNumber.getText().toString())==mAnswer){
            ...
            mVerticalFinalNumber.setTextColor(getResources().getColor(R.color.correct_green));
        }else{
            ((ImageView) findViewById(R.id.btnValidate))
            ...
            mVerticalFinalNumber.setTextColor(getResources().getColor(R.color.incorrect_red));
            ...
            switch(mProcessGuessPosition){
                ...
                case 2:{
                    ...
                    if(mCorrect){
                        ...
                        mVerticalFinalNumber.setText("");
                        mVerticalFinalNumber.setTextColor(
