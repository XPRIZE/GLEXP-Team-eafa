...
public class Activity_TL01 extends Activity_General_Parent implements LoaderManager.LoaderCallbacks<Cursor>{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tl01);
	...
	private long playInstructionAudio(){
		return playGeneralAudio("info_tl01.mp3");
	}
...
//		currentText.add(new ArrayList<String>(allActivityText.get(roundNumber).get(0)));
	...
	//	validateFlash.postDelayed(processValidateFlash, (long)50);
		switch(frameNumber){
			default:
			case 0:{
				((ImageView)findViewById(R.id.Activity_TextFrame1)).setImageResource(R.drawable.frm_tl01_on);
				break;
			}
			case 1:{
				((ImageView)findViewById(R.id.Activity_TextFrame2)).setImageResource(R.drawable.frm_tl01_on);
				break;
			}
			case 2:{
				((ImageView)findViewById(R.id.Activity_TextFrame3)).setImageResource(R.drawable.frm_tl01_on);
				break;
			}
			case 3:{
				((ImageView)findViewById(R.id.Activity_TextFrame4)).setImageResource(R.drawable.frm_tl01_on);
				break;
			}
		}
	}
	...
	private void clearFrames(){
		//clear frames
		((ImageView)findViewById(R.id.Activity_TextFrame1)).setImageResource(R.drawable.frm_tl01_off);
		((ImageView)findViewById(R.id.Activity_TextFrame2)).setImageResource(R.drawable.frm_tl01_off);
		((ImageView)findViewById(R.id.Activity_TextFrame3)).setImageResource(R.drawable.frm_tl01_off);
		((ImageView)findViewById(R.id.Activity_TextFrame4)).setImageResource(R.drawable.frm_tl01_off);
