...
public class Activity_LT05 extends Activity_General_Parent  implements
    ...
    */
    ...
    private void displayScreen(Cursor mCursor){
        ...
        while(mCursor.moveToNext()){
            ...
            currentWords.get(mCurrentLetter).add(mCursor.getString(mCursor.getColumnIndex(Database.Letters.LETTER_ID)));
            currentWords.get(mCurrentLetter).add(mCursor.getString(mCursor.getColumnIndex(Database.Letters.LETTER_TEXT)));
            currentWords.get(mCurrentLetter).add(mCursor.getString(mCursor.getColumnIndex(Database.Letters.AUDIO_URL)));
            mCurrentLetter++;
        }
    ...
    private void setTextCase(){
        if(mLowerCase){
            ((TextView)findViewById(R.id.letter_1)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_2)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_3)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_4)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_5)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_6)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_7)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_8)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_9)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_10)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_11)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_12)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_13)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_14)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_15)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_16)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_17)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_18)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_19)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_20)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_21)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_22)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_23)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_24)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_25)).setAllCaps(true);
            ((TextView)findViewById(R.id.letter_26)).setAllCaps(true);
        }else{
            ((TextView)findViewById(R.id.letter_1)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_2)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_3)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_4)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_5)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_6)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_7)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_8)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_9)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_10)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_11)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_12)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_13)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_14)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_15)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_16)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_17)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_18)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_19)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_20)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_21)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_22)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_23)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_24)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_25)).setAllCaps(false);
            ((TextView)findViewById(R.id.letter_26)).setAllCaps(false);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        switch(id){
            ...
            case MotoliConstants.ACTIVITY_CURRENT_WRDS_LTRS:{
                ...
                String selection=Database.Variable_Phase_Levels.GROUP_ID+"="+currentGSP.get(0)
                        +" AND "+Database.Variable_Phase_Levels.PHASE_ID+"=1"//+currentGSP.get(1)
                        +" AND "+Database.Variable_Phase_Levels.LEVEL_NUMBER+"<="+currentGSP.get(3);

                cursorLoader = new CursorLoader(this,
                        MotoliContentProvider.CONTENT_URI_ACTIVITY_CURRENT_LETTERS, null, selection, null, null);
                break;
            }
        }
