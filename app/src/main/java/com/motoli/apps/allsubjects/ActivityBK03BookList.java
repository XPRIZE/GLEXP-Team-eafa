 ...
 * on 10/13/2015.
 */
public class ActivityBK03BookList extends Activity_General_Parent  implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bk03_book_list);
        ...
        switch(id){
            ...
            case MotoliConstants.CURRENT_PHNC_LTRS:{
                ...
                String selection=Database.Variable_Phase_Levels.VARIABLE_PHASE_LEVELS_TABLE+"."+Database.Variable_Phase_Levels.GROUP_ID+"="+currentGSP.get(0)
                        ...
                        +" AND "+Database.Variable_Phase_Levels.VARIABLE_PHASE_LEVELS_TABLE+"."+Database.Variable_Phase_Levels.LEVEL_NUMBER+"<="+currentGSP.get(3);
